...
- AMW-633 Add support for WildFly configuration snapshots and rollback mechanism `#405 <https://github.com/ansible-middleware/wildfly/pull/405>`_
- AMW-636 Implement server update rollback using prospero `#408 <https://github.com/ansible-middleware/wildfly/pull/408>`_

Minor Changes
-------------

- AMW-590 Collection spelling and grammar checking for PRs `#402 <https://github.com/ansible-middleware/wildfly/pull/402>`_
- AMW-599 Update WildFly 41.0.0.Final version in wildfly collection `#399 <https://github.com/ansible-middleware/wildfly/pull/399>`_
- AMW-614 Add galaxy-importer job in CI to reproduce sab Hub linting issue. `#400 <https://github.com/ansible-middleware/wildfly/pull/400>`_
- AMW-636 Adding the revert history showcase capability `#409 <https://github.com/ansible-middleware/wildfly/pull/409>`_
- Fix galaxy-importer lint warnings `#410 <https://github.com/ansible-middleware/wildfly/pull/410>`_
- Replace deprecated ANSIBLE_COLLECTIONS_PATHS with singular form `#404 <https://github.com/ansible-middleware/wildfly/pull/404>`_

Bugfixes
--------

- AMW-640 Fix molecule test failures in EAP collection after refactoring and EAP 8.1 compatibility `#411 <https://github.com/ansible-middleware/wildfly/pull/411>`_
...
- AMW-540 Fix the upstream collection requirements with common v1.2.4 `#374 <https://github.com/ansible-middleware/wildfly/pull/374>`_

Bugfixes
--------

- Fix certification requirements for WildFly `#372 <https://github.com/ansible-middleware/wildfly/pull/372>`_
...
- AMW-491 In migration role default value of eap_migration_path_to_env_properties does not exists `#341 <https://github.com/ansible-middleware/wildfly/pull/341>`_
- AMW-492 migration role doesn't run migration tool `#342 <https://github.com/ansible-middleware/wildfly/pull/342>`_
- AMW-493 Unable to install EAP 7.4 with eap_java_version: 1.8 `#353 <https://github.com/ansible-middleware/wildfly/pull/353>`_
- AMW-497 Unable to install two different versions `#360 <https://github.com/ansible-middleware/wildfly/pull/360>`_
- AMW-499 Wrong migration tool is downloaded `#345 <https://github.com/ansible-middleware/wildfly/pull/345>`_
- Add offline install support for wildfly_driver role `#344 <https://github.com/ansible-middleware/wildfly/pull/344>`_
- Fix eap 7.4.0 and 8.0.0>= installation `#337 <https://github.com/ansible-middleware/wildfly/pull/337>`_

Minor Changes
-------------

- AMW-471 EAP collection is not able to use JBoss Installation Manager `#318 <https://github.com/ansible-middleware/wildfly/pull/318>`_
- AMW-472 WildFly: Adding and fixing all the molecule scenarios in GH action `#320 <https://github.com/ansible-middleware/wildfly/pull/320>`_
- AMW-473 Disabling RHEL10 testing from wildfly collection `#322 <https://github.com/ansible-middleware/wildfly/pull/322>`_
- AMW-475 eap_version argument is misleading in EAP Ansible collections `#324 <https://github.com/ansible-middleware/wildfly/pull/324>`_
- AMW-477 For eap collection added JIM compatibilities to use repos & manifest by passing arguments `#326 <https://github.com/ansible-middleware/wildfly/pull/326>`_
- AMW-480 Make eap collection compatible with eap 8.1.0 `#330 <https://github.com/ansible-middleware/wildfly/pull/330>`_
- AMW-481 Enable YAML config for eap 8>= version `#331 <https://github.com/ansible-middleware/wildfly/pull/331>`_
- AMW-492 migration molecule naming change & permission fix `#356 <https://github.com/ansible-middleware/wildfly/pull/356>`_
...
- AMW-482 molecule tests fix according to EAP 8.0.0 `#332 <https://github.com/ansible-middleware/wildfly/pull/332>`_
- Add app_deploy_standalone to molecule workflow `#319 <https://github.com/ansible-middleware/wildfly/pull/319>`_
